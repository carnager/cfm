...
use Cfm::Ui::Wizard::FixPlaybackWizard;
...
has fix_playback_wizard => singleton 'Cfm::Ui::Wizard::FixPlaybackWizard';
...
sub cmd_fix {
    ...
    my $acc = $self->select_playback_wizard->select_broken;
    return unless defined $acc;
    $self->fix_playback_wizard->fix_acc_playback($acc);
}
